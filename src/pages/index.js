...
export default function Home() {
  ...
  return (
    ...
    <div className=' w-[100vw] h-[100vh] bg-purple-500  grid md:grid-rows-[80px_550px_650px_550px_600px_600px] grid-rows-[260px_450px_650px_550px_600px_600px] overflow-x-hidden mx-auto grid-cols-4 text-center gap-0.5 text-white'>
