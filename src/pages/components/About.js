...
const About = () => {
  ...
  return (
    <div className='md:p-8 p-4  '>
      ...
      <p className=' text-justify text-lg text-white md:w-96 w-full '>I specialize in developing web applications using Node.js, Express.js, HTML, CSS, JavaScript, React.js, and Next.js. For mobile app development, I leverage Expo CLI and React Native. Additionally, I have experience working with Redux , React Query as well as Tailwind CSS and Bootstrap for styling </p>
